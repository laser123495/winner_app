...
class perhitungan3 : AppCompatActivity() {
    private lateinit var binding:ActivityPerhitungan3Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityPerhitungan3Binding.inflate(layoutInflater)
        setContentView(binding.root)
        var mediaPlayer = MediaPlayer.create(this,R.raw.rabbit)
        mediaPlayer.start()
        ...
        binding.tb1help.setOnClickListener {
            ...
            Toast.makeText(applicationContext,"kelincinyanya ada 5",Toast.LENGTH_SHORT).show()
        }
        ...
        binding.button3.setOnClickListener {
            ...
            mediaPlayer.start()
            val intent = Intent(this,perhitungan4::class.java)
