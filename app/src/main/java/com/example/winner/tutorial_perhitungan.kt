...
import com.example.winner.databinding.ActivityTutorialPerhitunganBinding
...
class tutorial_perhitungan : AppCompatActivity() {
    private lateinit var binding:ActivityTutorialPerhitunganBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTutorialPerhitunganBinding.inflate(layoutInflater)
